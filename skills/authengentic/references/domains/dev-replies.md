...
Covers replies on pull requests and issues, code-review comments, and discussion-thread responses. Run with `SKILL.md` (short-answer weighting: factuality, specificity, templatedness).
...
| Perfectly uniform comment structure across a review (every comment: praise plus issue plus suggestion) | Vary. Some comments are one word ("nit: typo"), some are paragraphs |
